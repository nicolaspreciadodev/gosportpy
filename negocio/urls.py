...
urlpatterns = [
    ...
    path('torneos/<int:pk>/solicitar-modificacion/', views.SolicitarModificacionTorneoView.as_view(), name='solicitar_modificacion_torneo'),
    path('torneos/modificacion/<int:pk>/responder/', views.ResponderSolicitudModificacionView.as_view(), name='responder_solicitud_modificacion'),
